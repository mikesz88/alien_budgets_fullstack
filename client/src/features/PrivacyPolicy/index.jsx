...
const PrivacyPolicy = () => (
  <>
    ...
    <div style={{ marginTop: '6rem' }}>
      ...
      <div>
        This privacy notice for Michael Sanchez (&quot;Company,&quot;
      ...
      <ul>
        <li>
          Visit our website at https://www.alienbudgets.com, or any website of
      ...
      <div>
        ...
        information depending on how you interact with Michael Sanchez and the
      ...
      <div>
        ...
        <a
          href="https://app.termly.io/notify/fd3b3487-0460-438e-b8b0-d453a0e21dee"
          target="_blank"
      ...
      <div>
        Want to learn more about what Michael Sanchez does with any information
        we collect?{' '}
      </div>
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>Sensitive Information</span> We do
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>In Short: </span>We process your
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>In Short: </span>We may share
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>In Short: </span>We may use cookies
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>In Short: </span>We keep your
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>In Short: </span>We aim to protect
      ...
      <p>
        ...
        secure, so we cannot promise or guarantee that hackers, Compliance
        Checklist 3 cybercriminals, or other unauthorized third parties will not
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>In Short: </span>You may review,
      ...
      <p>
        ...
        about your privacy rights, you may email us at alienbudgets@hotmail.com.
      </p>
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>In Short: </span>Yes, if you are a
      ...
      <ul>
        <li>Yes to Identifiers</li>
        <li>
          <ul>
            <li>
              Examples: Contact details, such as real name, alias, postal
        ...
        <li>
          Yes to Personal information categories listed in the California
          Customer Records statute
        </li>
        <li>
          <ul>
            <li>
              Examples: Name, contact information, education, employment,
      ...
      <ul>
        ...
        <li>Participation in customer surveys oor contests; and</li>
        <li>
      ...
      <p>
        ...
        alienbudgets@hotmail.com, or by referring to the contact details at the
      ...
      <p>
        ...
        Each service provider is a forprofit entity that processes the
        ...
        be &quot;selling&quot; of your personal information. Michael Sanchez has
        ...
        Michael Sanchez will not sell personal information in the future
      ...
      <p>
        ...
        by law, such as (but not limited to) Compliance Checklist 3 the exercise
      ...
      <p>Depending ont he circumstances, you have a right to know: </p>
      <ul>
      ...
      <p>
        <span style={{ fontWeight: 'bold' }}>In Short: </span> Yes, we will
